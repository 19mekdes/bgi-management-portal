...
const getPreferences = async (req: { user: { id: any; }; }, res: { json: (arg0: { success: boolean; preferences: any; }) => void; status: (arg0: number) => { (): any; new(): any; json: { (arg0: { success: boolean